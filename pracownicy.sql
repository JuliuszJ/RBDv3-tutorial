...
CREATE TABLE PRACOWNICY
       (ID_PRAC NUMERIC(6) CONSTRAINT PK_PRAC PRIMARY KEY,
	NAZWISKO VARCHAR(15),
	ETAT VARCHAR(10), -- CONSTRAINT FK_ETAT REFERENCES ETATY(NAZWA),
	ID_SZEFA NUMERIC(6) CONSTRAINT FK_ID_SZEFA REFERENCES PRACOWNICY(ID_PRAC),
	ZATRUDNIONY DATE,
	PLACA_POD NUMERIC(6,2) CONSTRAINT MIN_PLACA_POD CHECK(PLACA_POD>100),
	PLACA_DOD NUMERIC(6,2),
	ID_ZESP NUMERIC(4) -- CONSTRAINT FK_ID_ZESP REFERENCES ZESPOLY(ID_ZESP)
	);
